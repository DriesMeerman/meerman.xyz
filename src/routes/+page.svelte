...
<Person>
  <p class="max-w-3/4 sm:text-justify">
    ...
    Programming from that point on became the thing I wanted focus on and improve my skills.
    ...
    I have <a class="underline" href="/cats">two cats</a>, Henrietta and Gina, they are commonly known as fen fen, gina beena, goony b coots, juniper breeze and foonry winks or just the coots.
  </p>
</Person>
